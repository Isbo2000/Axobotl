...
module.exports = {
    ...
    callback: async (message, arguments, text) => {
        ...
        if ((lotx.includes("are")) && (lotx.includes("you")) && (lotx.includes("sentient"))) {
        ...
        const applyText = (canvas, quote) => {
            ...
            } while ((context.measureText(quote).width > canvas.width - 50) && (context.measureText(quote).width > 50));
            return context.font;
        };
        const canvas = Canvas.createCanvas(478, 478);
        const context = canvas.getContext('2d');
        const background = await Canvas.loadImage('./assets/imagecommands/larry/Larry.png');
        ...
        const attachment = new MessageAttachment(canvas.toBuffer(), 'AllKnowingLarry.png');
