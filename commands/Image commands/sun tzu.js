...
module.exports = {
    ...
    callback: async (message, arguments, text) => {
        ...
        const context = canvas.getContext('2d');
        const background = await Canvas.loadImage('./assets/imagecommands/suntzu/sun-tzu.png');
        ...
        const attachment = new MessageAttachment(canvas.toBuffer(), 'SunTzuFakeQuote.png');
